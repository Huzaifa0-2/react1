...
const Githubsearch = () => {
    ...
    // const userLink = searchParams.get()
        ...
        <>
            ...
            {userData && (
                <div className="text-center m-4 bg-gray-800 p-6 rounded-lg shadow-lg">
                    ...
                    />
                    <a className='px-6 py-2 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-75' href={`https://github.com/${user}`} target="_blank" rel="noopener noreferrer">
